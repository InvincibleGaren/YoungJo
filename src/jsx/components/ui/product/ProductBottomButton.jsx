                        ...
                        <div className="mndtl_opt_comp" id="selectItemArea">
                          ...
                          <div className="mndtl_opt_bx" id="optBarDynamicArea">
                              <div id="qty_area_1000449529305_00002" className="mndtl_opt_ani add">	
                                ...
                                <div className="mndtl_opt_selected active select_box">		
                                  <dl>			
                                    <dt>[상품03] 진도 엘페 휘메일 풀스킨  밍크 하프 코트 - 블랙(EJ01) / 블랙/L</dt>			
                                    ...
                                    <dd className="mndtl_art_r">			
                                        <span className="price"><em className="ssg_price">928,200</em><span className="ssg_tx">원</span></span>			
                                    </dd>		
                                  </dl>		
