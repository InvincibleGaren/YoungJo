                ...
                <div className="in">
                    <div className="cmft_sel_wrap">
                        <span className="cmft_inp_chk">
                                    <input type="checkbox" id="ui_ship_view" value="magic_chk" defaultChecked="" /> 
                                </span>
            ...
            <li className="rank_td" data-areaid="order">
                <div className="in">
                    <Link to="#" className="btn_t" 
                        ...
                        }}>{sortCheck.selected}<span className="sp_view ico_arrow">&nbsp;</span></Link>
                    {
                        sortCheck.visible && 
                            <ul className="mn_layer">
                                <li onClickCapture={(e) => sortItemClick(e, "recommended")} name="recommended" className={sortState.recommended}>
                                    <Link to="#"
                                        className="clickable">추천순</Link>
                                        <button onclick="alert('추천순 상품의 판매량과 정확도 등을 점수화하여 정렬하며, 광고상품의 경우 별도 기준으로 상단에 정렬됩니다.');" className="btn_info"><span className="blind"></span></button>                                
                                </li>
                                <li onClickCapture={(e) => sortItemClick(e, "sales")} name="sales" className={sortState.sales}>
                                    <Link to="#" title="sale" className="clickable" data-info="sale">판매순</Link></li>
                                <li onClickCapture={(e) => sortItemClick(e, "lowPrice")} name="lowPrice" className={sortState.lowPrice}>
                                    <Link to="#" title="sale" className="clickable" data-info="sale">낮은가격</Link></li>
                                <li onClickCapture={(e) => sortItemClick(e, "highPrice")} name="highPrice" className={sortState.highPrice}>
                                    <Link to="#" title="sale" className="clickable" data-info="sale">높은가격</Link></li>
                                <li onClickCapture={(e) => sortItemClick(e, "NewProduct")} name="NewProduct" className={sortState.NewProduct}>
                                    <Link to="#" title="sale" className="clickable" data-info="sale">신상품순</Link></li>
                                <li onClickCapture={(e) => sortItemClick(e, "reviews")} name="reviews" className={sortState.reviews}>
                                    <Link to="#" title="sale" className="clickable" data-info="sale">리뷰많은순</Link></li>

                                {/* <li><a title="prcasc" href="#" className="clickable" data-info="prcasc">낮은가격</a></li>
                                <li><a title="prcdsc" href="#" className="clickable" data-info="prcdsc">높은가격</a></li>
            ...
            <li className="sch_td">
                <div className="in">
                    <Link to="#" className="btn_t" 
                        ...
                        }}>필터<span className="sp_view ico_arrow">&nbsp;</span></Link>
                    {
                        filterCheck.visible &&
                                        ...
                                        <div className="ds_cont">
                                            <span className="des_select">
                                                ...
                                                <span className="hide_select">
                                                    ...
                                                    <select id="category" title="옵션"><option value="all">전체</option><option value="6000200799" title="가방/지갑" className="clickable" data-info="6000200799">가방/지갑</option><option value="6000200803" title="명품잡화/아이웨어" className="clickable" data-info="6000200803">명품잡화/아이웨어</option><option value="6000205354" title="스포츠웨어/용품" className="clickable" data-info="6000205354">스포츠웨어/용품</option><option value="6000209194" title="컴퓨터/노트북/태블릿" className="clickable" data-info="6000209194">컴퓨터/노트북/태블릿</option><option value="6000205357" title="골프웨어/용품/클럽" className="clickable" data-info="6000205357">골프웨어/용품/클럽</option><option value="6000178523" title="주방용품" className="clickable" data-info="6000178523">주방용품</option><option value="6000211273" title="문구/미술/사무용품" className="clickable" data-info="6000211273">문구/미술/사무용품</option><option value="6000205356" title="캠핑/낚시용품" className="clickable" data-info="6000205356">캠핑/낚시용품</option><option value="6000209203" title="휴대폰/스마트기기" className="clickable" data-info="6000209203">휴대폰/스마트기기</option><option value="6000163573" title="유아동신발/잡화" className="clickable" data-info="6000163573">유아동신발/잡화</option><option value="6000200801" title="슈즈/운동화" className="clickable" data-info="6000200801">슈즈/운동화</option><option value="6000205355" title="등산/아웃도어" className="clickable" data-info="6000205355">등산/아웃도어</option><option value="6000178524" title="청소/욕실/공구" className="clickable" data-info="6000178524">청소/욕실/공구</option><option value="6000189224" title="여성브랜드패션" className="clickable" data-info="6000189224">여성브랜드패션</option><option value="6000178525" title="생활/건강" className="clickable" data-info="6000178525">생활/건강</option><option value="6000163570" title="완구/교구" className="clickable" data-info="6000163570">완구/교구</option><option value="6000177371" title="조명/인테리어소품" className="clickable" data-info="6000177371">조명/인테리어소품</option><option value="6000185640" title="반려동물용품" className="clickable" data-info="6000185640">반려동물용품</option><option value="6000189392" title="남성패션" className="clickable" data-info="6000189392">남성패션</option><option value="6000189308" title="여성트렌드패션" className="clickable" data-info="6000189308">여성트렌드패션</option><option value="6000201547" title="명품/수입의류" className="clickable" data-info="6000201547">명품/수입의류</option><option value="6000200800" title="모자/장갑/ACC" className="clickable" data-info="6000200800">모자/장갑/ACC</option><option value="6000209199" title="내비/블랙박스/차량용품" className="clickable" data-info="6000209199">내비/블랙박스/차량용품</option><option value="6000205360" title="구기/라켓스포츠" className="clickable" data-info="6000205360">구기/라켓스포츠</option><option value="6000205361" title="수영/수상레저" className="clickable" data-info="6000205361">수영/수상레저</option><option value="6000205358" title="자전거/스케이트/롤러" className="clickable" data-info="6000205358">자전거/스케이트/롤러</option><option value="6000139025" title="유제품/과자/빵/음료/주류" className="clickable" data-info="6000139025">유제품/과자/빵/음료/주류</option><option value="6000189500" title="캐주얼/유니섹스" className="clickable" data-info="6000189500">캐주얼/유니섹스</option><option value="6000200802" title="시계/쥬얼리" className="clickable" data-info="6000200802">시계/쥬얼리</option><option value="6000210596" title="도서" className="clickable" data-info="6000210596">도서</option><option value="6000163572" title="아동/주니어패션" className="clickable" data-info="6000163572">아동/주니어패션</option><option value="6000139864" title="반찬/간편식/조미료" className="clickable" data-info="6000139864">반찬/간편식/조미료</option><option value="6000139026" title="홍삼/건강식품" className="clickable" data-info="6000139026">홍삼/건강식품</option><option value="6000209197" title="카메라/캠코더" className="clickable" data-info="6000209197">카메라/캠코더</option><option value="6000177367" title="침구/커튼/카페트" className="clickable" data-info="6000177367">침구/커튼/카페트</option><option value="6000163568" title="출산/육아용품" className="clickable" data-info="6000163568">출산/육아용품</option><option value="6000189453" title="언더웨어" className="clickable" data-info="6000189453">언더웨어</option><option value="6000177368" title="침실/수납가구" className="clickable" data-info="6000177368">침실/수납가구</option><option value="6000205359" title="헬스/요가/격투기" className="clickable" data-info="6000205359">헬스/요가/격투기</option><option value="6000193743" title="향수" className="clickable" data-info="6000193743">향수</option><option value="6000163571" title="신생아/유아패션" className="clickable" data-info="6000163571">신생아/유아패션</option><option value="6000139023" title="수산물/건해산" className="clickable" data-info="6000139023">수산물/건해산</option><option value="6000018405" title="취미/키덜트" className="clickable" data-info="6000018405">취미/키덜트</option><option value="6000139022" title="정육/계란류" className="clickable" data-info="6000139022">정육/계란류</option><option value="6000209196" title="PC주변기기/저장장치" className="clickable" data-info="6000209196">PC주변기기/저장장치</option><option value="6000163569" title="유모차/카시트/실내용품" className="clickable" data-info="6000163569">유모차/카시트/실내용품</option><option value="6000177370" title="서재/학생아동가구" className="clickable" data-info="6000177370">서재/학생아동가구</option><option value="6000139021" title="과일/채소/쌀" className="clickable" data-info="6000139021">과일/채소/쌀</option><option value="3500000958" title="악기" className="clickable" data-info="3500000958">악기</option><option value="6000193747" title="미용기기/소품" className="clickable" data-info="6000193747">미용기기/소품</option><option value="6000177372" title="DIY/시공" className="clickable" data-info="6000177372">DIY/시공</option><option value="6000185643" title="관상어용품" className="clickable" data-info="6000185643">관상어용품</option><option value="6000185638" title="강아지사료/간식" className="clickable" data-info="6000185638">강아지사료/간식</option><option value="6000177369" title="거실/주방가구" className="clickable" data-info="6000177369">거실/주방가구</option><option value="6000193745" title="바디케어" className="clickable" data-info="6000193745">바디케어</option><option value="6000209200" title="냉장고/주방가전" className="clickable" data-info="6000209200">냉장고/주방가전</option><option value="6000209202" title="영상/음향가전" className="clickable" data-info="6000209202">영상/음향가전</option><option value="6000193742" title="스킨케어" className="clickable" data-info="6000193742">스킨케어</option><option value="6000163567" title="기저귀/물티슈/분유/유아식" className="clickable" data-info="6000163567">기저귀/물티슈/분유/유아식</option><option value="6000209198" title="에어컨/계절가전" className="clickable" data-info="6000209198">에어컨/계절가전</option><option value="6000209195" title="게임/타이틀" className="clickable" data-info="6000209195">게임/타이틀</option><option value="6000185639" title="고양이사료/간식" className="clickable" data-info="6000185639">고양이사료/간식</option><option value="6000193744" title="헤어케어" className="clickable" data-info="6000193744">헤어케어</option><option value="6000193746" title="메이크업" className="clickable" data-info="6000193746">메이크업</option><option value="6000209201" title="세탁기/생활가전" className="clickable" data-info="6000209201">세탁기/생활가전</option><option value="6000083312" title="음반/DVD" className="clickable" data-info="6000083312">음반/DVD</option><option value="6000185642" title="소동물/곤충/조류" className="clickable" data-info="6000185642">소동물/곤충/조류</option><option value="6000205362" title="스키/보드" className="clickable" data-info="6000205362">스키/보드</option><option value="6000203402" title="렌탈" className="clickable" data-info="6000203402">렌탈</option><option value="3000001210" title="여행/호텔/레저" className="clickable" data-info="3000001210">여행/호텔/레저</option><option value="6000211386" title="e쿠폰/상품권" className="clickable" data-info="6000211386">e쿠폰/상품권</option><option value="6000211373" title="서비스" className="clickable" data-info="6000211373">서비스</option></select>
                                                </span>
                                            </span>
                                        </div>
                                    </div>
