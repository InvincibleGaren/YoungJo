...
function SearchFilter() {
    return (  
        <ul className="SearchFilter m_ncatetbl">
            ...
            <li class="rank_td" data-areaid="order">
                <div class="in">
                    <a href="#" class="btn_t">판매량순<span class="sp_view ico_arrow">&nbsp;</span></a>
                    <ul class="mn_layer">
                    <li>
                    ...
                    <li class="active"><a title="sale" href="#" class="clickable" data-info="sale">판매량순</a></li>
